...
for T in range(int(input())):
    ...
    score_dict = {
        ...
        for i in range(1, nums_team + 1)  # 0번째는 cnt 횟수로 하자 마지막은 last_submit
    }
    ...
    # print(list(score_dict[team_id].values())[1:-1])
    # print(my_team_score)
    # print(sum(list(score_dict[i].values())[1:-1]))
    # print(list(score_dict[1].values())[1:-1])
    compare_list = [
        [
            i,
